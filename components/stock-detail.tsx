...
export function CandleChart({ rows }: { rows: Candle[] }) {
  ...
  return <figure className="stock-candles"><svg viewBox="0 0 800 310" role="img" aria-label="最近六十个交易日日K线与成交量">
  ...
  </svg><figcaption>前复权日线 · 上方价格，下方成交量（股）；悬停查看单日数据</figcaption></figure>;
}
