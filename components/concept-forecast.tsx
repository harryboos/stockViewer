    ...
    <div className="content forecast-content">
      <section className="concept-ai-section forecast-section" aria-labelledby="concept-forecast-title" aria-busy={busy}>
        ...
        <div aria-live="polite">
          ...
          {busy && <div className="concept-ai-state concept-ai-progress"><span className="loading-ring" /><div><strong>正在结合三方面进行 MAX 深度预测</strong><p>正在收集行情与现实事件，推演未来半个月的影响，最多等待 10 分钟。可以切换其他 Tab，返回后继续查看结果。</p></div></div>}
